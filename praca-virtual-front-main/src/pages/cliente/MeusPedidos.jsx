// src/pages/cliente/MeusPedidos.jsx — conectado à API real
              ...
              return (
                <div key={pedido.id} className="rounded-2xl p-4 flex flex-col gap-3 bg-[#1E1E1E]">
                  <div className="flex gap-3">
                    <div className="w-20 h-20 rounded-xl flex-shrink-0 bg-[#2A2A2A] flex items-center justify-center text-3xl">
                      🍽️
                    </div>
